    ...
    <>
      <section className="py-12">
        <div className="containers">
          ...
          <p className="text-center text-black/60 font-medium">Check what’s popular on SnapHub and make your project look trendy and professional.</p>
          <div>
            <div className="grid grid-cols-2 gap-5 mt-12">
              <div>
                <Card title="Title One" image="src/assets/images/b1.avif" styles="h-[480px] rounded-tl-xl" />
              </div>
              <div className="grid grid-cols-2 gap-5">
                <Card title="Title One" image="src/assets/images/b2.avif" />
                <Card title="Title One" image="src/assets/images/b3.avif" styles="rounded-tr-xl" />
                <Card title="Title One" image="src/assets/images/b4.avif" styles="h-[220px]" />
                <Card title="Title One" image="src/assets/images/b5.avif" />
              </div>
            </div>
            <br />
            <div className="grid grid-cols-4 gap-5">
              <Card title="Title One" image="src/assets/images/b5.avif" styles="h-[225px] rounded-bl-xl" />
              <Card title="Title One" image="src/assets/images/b1.avif" />
              <Card title="Title One" image="src/assets/images/b3.avif" />
              <Card title="Title One" image="src/assets/images/b2.avif" styles="rounded-br-xl" />
            </div>
          </div>
        </div>
      </section>
    ...
    <section className="pb-12">
      <div className="containers">
        ...
        <div className="grid grid-cols-4 gap-16 mt-12">
          <Card title="Title One" image="src/assets/images/e1.avif" styles="h-96 rounded-xl" show={true} />
          <Card title="Title One" image="src/assets/images/e2.avif" styles="h-96 rounded-xl" show={true} />
          <Card title="Title One" image="src/assets/images/e3.avif" styles="h-96 rounded-xl" show={true} />
          <Card title="Title One" image="src/assets/images/e4.avif" styles="h-96 rounded-xl" show={true} />
        </div>
      </div>
    </section>
  );
    ...
    <section className="pb-12">
      <div className="containers">
        ...
        <div className="grid grid-cols-2 gap-5">
          ...
          <div className="right">
            <img src="src/assets/images/banner1.webp" alt="banner1" className="w-full h-full object-contain" />
          </div>
        </div>
      </div>
    </section>
        ...
        <div className="containers text-white flex items-center justify-between">
          ...
          <div className="right">
            <div className="w-full h-full object-contain pt-32">
              <img src="/src/assets/images/banner2.webp" alt="banner2" className="w-full h-full object-contain" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="containers px-32 bg-indigo-50 rounded-xl flex items-center justify-between">
          ...
          <div className="right h-[40vh]">
            <div className="w-full h-full object-contain">
              <img src="/src/assets/images/banner3.webp" alt="banner2" className="w-full h-full object-contain" />
            </div>
          </div>
        </div>
      </section>
